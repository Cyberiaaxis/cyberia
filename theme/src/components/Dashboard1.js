                    ...
                    topBar.map((menuTitle, key) => {
                        ...
                        if (menuTitle.subMenu) {
                            menuTitle.subMenu.map(subMenu => {
                                ...
                                subMenuList.push(<li><Link to='#' className={section === subMenu.url ? 'menuList nav-link active' : 'menuList nav-link'} key={key} href="#" data-href={subMenu.url}>{subMenu.name}</Link></li>);
                        ...
                        return (
                            <li>
                               <Link to='#' className={section === menuTitle.url ? 'menuList nav-link active' : 'menuList nav-link'} key={key} href="#" data-href={menuTitle.url}>{menuTitle.name}</Link>
