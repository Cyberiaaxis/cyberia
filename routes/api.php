...
$route->post('/register', 'RegistrationController@signup');
...
// $route->group(
//     ,
$route->group(['middleware' => ['auth:api', 'verified']], function($route){
    $route->get('/home', 'HomeController@index');
    $route->get('/crimes', 'CrimeController@crimes')->name('crimes');
        $route->resources([
                        // '/home' => 'HomeController',
