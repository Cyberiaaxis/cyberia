<nav id="sidebar" class="">
    <div class="sidebar-header">  
        <a href="/"><img class="main-logo" src="{{ asset('storage/templateimages/logo/logo.png') }}" alt="" /></a>
    ...
    <div class="left-custom-menu-adp-wrap comment-scrollbar">
        <nav class="sidebar-nav left-sidebar-menu-pro">
            ...
            <li>
                ...
                <ul class="submenu-angle" aria-expanded="false">
                    <li class="{{ set_active('staff*') }}"><a title="Permissions" href="/staff/permissions"><span class="mini-sub-pro">Permissions</span></a></li>
                </ul>
            </li>
            <li>
                <a title="users" href="/staff/users" aria-expanded="false"><span class="educate-icon educate-event icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Users</span></a>
                    ...
                    <ul class="submenu-angle" aria-expanded="true">
                        <li><a title="Dashboard v.1" href="#"><span class="mini-sub-pro">Role User</span></a></li>
                        <li><a title="Dashboard v.2" href="#"><span class="mini-sub-pro">Example-1</span></a></li>
                        <li><a title="Dashboard v.3" href="#"><span class="mini-sub-pro">Example-2</span></a></li>
                        <li><a title="Analytics" href="#"><span class="mini-sub-pro">Example-3</span></a></li>
                        <li><a title="Widgets" href="#"><span class="mini-sub-pro">Example-4</span></a></li>
                    </ul>
                </li>
                <li>
